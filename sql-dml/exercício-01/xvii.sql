...
SELECT c.nome curso, a.nome, count(*) as num_reprovacoes 
FROM aluno a
...
-- Atualmente na base de dados não existe um curso de Engenharia Informática cadastrado.
-- Para que a consulta retorne valores, substitua a condição abaixo por Informática ou Contabilidade e Fiscalidade. 
WHERE c.nome = 'Engenharia Informática'
